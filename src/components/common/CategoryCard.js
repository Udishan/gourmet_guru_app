...
const CategoryCard = ({ categoryName, categoryThumnailUrl, categoryDescription }) => {
    return (
        <div className='h-auto w-64 bg-green-100 border border-spacing-1 border-black px-2'>
            <div>
